...
<?php include "../../php/User/getMeetingDetails.php"; ?>

<script type="text/javascript" src="../../js/User/meetingDetails.js"></script>
<link rel="stylesheet" type="text/css" href="../../css/User/meetingDetails.css">
    ...
    <main>
      <div class="container-fluid">
        ...
        <br>
          ...
          <div class="form-group">
            <h4>صاحب الإجتماع</h4>
            <p class="mr-2"><b><?= $meetingInfo['invitor_name']; ?></b></p>
          </div>
        ...
        <div id="CommentsDiv" class="col-md-8">
          <h4>مخرجات الإجتماع</h4>
          <?php if ($meetingInfo['meet_outcome'] == '') { ?>
              لا توجد مخرجات
          <?php }else{ ?>
            <div id="taskComments"><?= $meetingInfo['meet_outcome']; ?></div>
          <?php } ?>
        </div>
