...
<?php include "../../php/User/getUsers.php" ?>

<script type="text/javascript" src="../../js/User/addReport.js"></script>
<link rel="stylesheet" type="text/css" href="../../css/User/addReport.css">
        ...
        <div class="card col-sm-3"></div>
          <div class="container">
            ...
            <div id="reportDiv" class="mt-4 well col-xs-12">
              ...
              <form method="post" action="../../php/User/addReport.php" id="addReportForm">
