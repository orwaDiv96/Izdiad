...
<?php include "../../php/Admin/getTaskDetails.php"; ?>

<script type="text/javascript" src="../../js/Admin/taskDetails.js"></script>
    ...
    <main>
      <div class="container-fluid">
        ...
        <br>
          ...
          <div class="form-group ">
            <h4>المسؤولون عن المهمة:</h4>
            <?php 
              $responsibleID = $taskInfo['responsibleEmp_id'];
        ...
        <div id="addTaskCommentDiv" class="well col-sm-8">
          <h4>إضافة تعليق</h4>
          <form action="../../php/Admin/addTaskComment.php" id="addTaskCommentForm" method="post">
